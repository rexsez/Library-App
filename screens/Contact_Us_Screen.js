            ...
            <ScrollView>
              <View style={{ borderBottomWidth: 2, borderColor: "gray" }}>
                ...
                <Text style={styles.text}>
                  <Text style={styles.headText}>- Send us email at:</Text>
                  <Text
                ...
                <Text style={styles.text}>
                  <Text style={styles.headText}>- Visit us in person:</Text>
                  1st Floor PSU Men's College Main Building (beside the Mosque)
                </Text>
                <Text style={styles.headText}>- Address:</Text>
                <Text style={styles.text}>
                  Prince Sultan University, P.O.Box No. 66833, Rafha Street,
                  Riyadh 11586. Saudi Arabia. Tel : +966-1-494-8120| Fax:
                  +966-1-454-8317
                </Text>
